...
export const ptTracking = {
  ...
  settings: {
    ...
    nativeOsNotificationsDesc: 'Mostrar notificações nativas do SO quando a aplicação está minimizada ou em segundo plano',
    osOnlyNotifications:       'Apenas notificações SO',
    osOnlyNotificationsDesc:   'Usar exclusivamente notificações do SO — sem pop-ups na aplicação. As notificações SO aparecem sempre, independentemente do estado da janela.',
    notifyWhenFocused:         'Notificar com o sistema aberto',
    notifyWhenFocusedDesc:     'Mostrar notificações SO mesmo quando a janela está activa e em primeiro plano (por defeito, só notifica quando minimizada)',

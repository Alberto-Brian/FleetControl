...
export function exposeSystemContext() {
    ...
    contextBridge.exposeInMainWorld("system", {
        ...
        deleteDatabase:      (filepath: string, password: string) => ipcRenderer.invoke(DELETE_DATABASE, { filepath, password }),
        listBackupDatabases: () => ipcRenderer.invoke(LIST_BACKUP_DATABASES),
    });
}

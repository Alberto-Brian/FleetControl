// src/helpers/ipc/db/fuel-stations/fuel-stations-channels.ts
export const CREATE_FUEL_STATION = "db-fuel-stations:create";
export const GET_ALL_FUEL_STATIONS = "db-fuel-stations:get-all";

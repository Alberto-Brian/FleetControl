...
import { KPICards, LineChart, HBarChart } from '@/components/PDFCharts';
          ...
          >
            ...
            <SummaryBox items={[
              ...
              { 
                ...
                value: formatCurrency((stats.totalCost ?? 0) / (stats.total || 1)) 
              },
              { 
                label: 'Média litros por abastecimento',
                value: `${((stats.totalLiters ?? 0) / (stats.total || 1)).toFixed(2)} L` 
              },
            ]} />
          </View>
        )}

...
const ptTranslations = {
  ...
  sections: {
    ...
    topVehicles: 'Top Veículos por Consumo',
  ...
  // Charts
  charts: {
    fuelEvolution: 'Evolução do Consumo',
    tripsEvolution: 'Evolução Mensal de Viagens',
    costEvolution: 'Evolução de Custos',
    consumptionByVehicle: 'Consumo por Veículo',
    tripsByStatus: 'Viagens por Status',
  },
  ...
  // Empty State
  empty: {
    noData: 'Nenhum dado encontrado para o período seleccionado',
  ...
  footer: {
    ...
    generatedBy: 'Gerado por FleetControl',
  },
};
...
const enTranslations = {
  ...
  sections: {
    ...
    topVehicles: 'Top Vehicles by Consumption',
  ...
  // Charts
  charts: {
    fuelEvolution: 'Fuel Consumption Evolution',
    tripsEvolution: 'Monthly Trips Evolution',
    costEvolution: 'Cost Evolution',
    consumptionByVehicle: 'Consumption by Vehicle',
  ...
  empty: {
    ...
    noRefuelings: 'No refuelings recorded',
    noMaintenances: 'No maintenances recorded',
  },
  
  // Footer
  footer: {
    confidential: 'Confidential Document',
    generatedBy: 'Generated by FleetControl',
  },
};
